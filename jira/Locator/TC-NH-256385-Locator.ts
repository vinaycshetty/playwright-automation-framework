...
export class CashConcentrationPageGenerated {
  ...
  private USACH_BATCH_BDACHCD_mdf_BATCH_USACH_BDACHCD_0_COMPIDNAME_select_field = '[data-qa="USACH-BATCH-BDACHCD-mdf-BATCH-USACH-BDACHCD-0-COMPIDNAME-select-field"]';
  ...
  private AMOUNT_view547 = '#AMOUNT-view547';
  ...
  async set_USACH_BATCH_BDACHCD_mdf_BATCH_USACH_BDACHCD_0_COMPIDNAME_select_field(value: string) { await this.page.fill(this.USACH_BATCH_BDACHCD_mdf_BATCH_USACH_BDACHCD_0_COMPIDNAME_select_field, value); }
  ...
  async set_AMOUNT_view547(value: string) { await this.page.fill(this.AMOUNT_view547, value); }
